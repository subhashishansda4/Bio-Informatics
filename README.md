...
[article](https://www.tandfonline.com/doi/full/10.1517/17460441.2015.1016497)
...
## Process
#### CHEMBL database
Retrieving and downloading biological activity data from CHEMBL database to construct machine learning models or QSARs \
These data contains curated bioactivity data of more than 2 million compounds. It is compiled from more than 76,000 documents, 1.2 million essays and the data spans 13,000 targets, 1800 cells and 33,000 indications \
...
\
Search "acetylcholinesterase" in all targets 